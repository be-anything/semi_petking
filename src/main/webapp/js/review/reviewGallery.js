const getPhotos = (page) => {
    // 비동기 요청으로 photo를 5건씩 조회
    $.ajax({
        url: `${contextPath}/review/reviewPage`,
        data : {
            page
        },
        success(photos) {
            ...
            //     const {id, memberId, content, renamedName, readCount, regDate} = photo;
            //     return `${html}
            //     <div class="my-5 max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:shadow-lg">
            //         <img class="rounded-t-lg"
            //              src="${contextPath}/upload/review/${renamedName}"
            //              alt="" />
            //         <div class="p-5">

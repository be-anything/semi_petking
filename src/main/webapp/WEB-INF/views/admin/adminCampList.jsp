...
<div class="w-full mx-auto mt-8">
    <div class="overflow-x-auto">
        <table class="w-5/6 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border-collapse">
            ...
            <tr>
                <th scope="col" class="px-8 py-4 whitespace-nowrap">번호</th>
                ...
                <th scope="col" class="px-8 py-4 whitespace-nowrap">리뷰수</th>
                <th scope="col" class="px-8 py-4 whitespace-nowrap">좋아요수</th>
                <th scope="col" class="px-8 py-4 whitespace-nowrap">가입일</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${campVos}" var="camp" varStatus="vs">
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-8 py-6 whitespace-nowrap">${camp.businessId}</td>
                    <td class="px-8 py-6 whitespace-nowrap">${camp.businessName}</td>
                    ...
                    <td class="px-8 py-6 whitespace-nowrap">${camp.reviewCount}</td>
                    <td class="px-8 py-6 whitespace-nowrap">${camp.wishCount}</td>
                    <td class="px-8 py-6 whitespace-nowrap">

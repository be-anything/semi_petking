...
<div class="container mx-auto my-6">
    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-6xl rounded-lg bg-gray1 mb-10">
        <form name="roomUpdateFrm" method="post" enctype="multipart/form-data">
            <p></p>
...
<%--    roomRenamedImg 대표사진 확인 위해 roomImg->roomRenamedImg 임시변경                            --%>
                        ...
                        <dl class="divide-y divide-gray-100">
                            ...
                            <div class="px-4 py-4 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-0">
                                ...
                                <textarea type="text" id="roomIntro" name="roomIntro" rows="8"
                                   ...
                                   dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="객실 소개글을 작성해주세요.">${room.roomIntro}</textarea>
                            ...
                            <div>
                                <div class="div_person1 px-4 py-4 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-0">
                                    ...
                                    <input type="number" id="roomDefaultPerson" name="roomDefaultPerson" value="${room.roomDefaultPerson}"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                                ...
                                <div class="div_person2 px-4 py-4 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-0">
                                    ...
                                    <input type="number" id="roomMaximumPerson" name="roomMaximumPerson" value="${room.roomMaximumPerson}"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="div_person1 px-4 py-4 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-0">
                                    ...
                                    <input type="number" id="roomDefaultFee" name="roomDefaultFee" value="${room.roomDefaultFee}"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>

                                <div class="div_person2 px-4 py-4 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-0">
                                    <label for="roomMaximumPerson" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">추가 요금</label>
                                    <input type="number" id="roomOverFee" name="roomOverFee" value="${room.roomOverFee}"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                            </div>
    ...
    <script src="${pageContext.request.contextPath}/js/room/roomUpdate.js"></script>

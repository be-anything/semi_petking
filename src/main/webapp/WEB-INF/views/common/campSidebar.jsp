...
<aside class="fixed top-20 mt-10 z-40 w-64 h-1/2" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 text-black rounded-lg border border-gray2">
        <ul class="space-y-2 font-medium">
            <li class="mt-1">
                <button type="button" class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/room/roomList" class="flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">내 캠핑존 정보</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">예약 관리</span>
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/camp/campAskList?campId=${loginCamp.id}" class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">문의 관리</span>
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/camp/campReviewList?campId=${loginCamp.id}" class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">리뷰 관리</span>
                </a>
            </li>
        </ul>
    </div>

...
<div class="flex justify-between items-center mx-auto max-w-6xl rounded-lg mt-10">
    <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 ">
        <li class="tabBtn">
            <a href="${pageContext.request.contextPath}/user/userReservation" aria-current="page" class="inline-block p-4 rounded-t-lg text-white bg-green active px-5">완료된 예약</a>
        </li>
        <li class="tabBtn">
